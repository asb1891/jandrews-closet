...
with app.app_context():
    ...
    Dolce_and_Gabbana_Sweater = Clothes(designer_name='Dolce and Gabbana', description='Sweater', price=205, image_url="/assets/DGSweater.jpg")
    Dolce_and_Gabbana_Kimono= Clothes(designer_name='Dolce and Gabbana', description='Sheer Kimono', price=480, image_url="/assets/DGK.jpg")
    Dior_Vneck_Top = Clothes(designer_name='Dior', description='Vneck Top', price=175, image_url="/assets/DiorV.jpg")
    Dior_Sleeveless_Sweater = Clothes(designer_name='Dior', description= "sleeveless sweater", price=199, image_url="/assets/DiorSweater.jpg")
    Fendi_Handbag = Clothes(designer_name='Fendi', description='Handbag', price=695, image_url="/assets/FendiClutch.jpg")
    Fendi_Clutch = Clothes(designer_name='Fendi', description='Clutch', price=455, image_url="/assets/FendiHB.jpg")
    LV_Jacket= Clothes(designer_name='Louis Vuitton', description='Jacket', price=805, image_url="/assets/LVJacket.jpg")
    LV_Down_Puffer_Jacket = Clothes(designer_name='Louis Vuitton', description='Down Puffer Jacket', price=1095, image_url="/assets/LVPuffer.jpg")
    Balmain_Snakeskin_Jacket = Clothes(designer_name='Balmain', description='Snakeskin Jacket', price=795, image_url="/assets/BalmainSnakeSkin.jpg")
    Balmain_Varsity_Jacket = Clothes(designer_name='Balmain', description='Varsity Jacket', price=896, image_url="/assets/BalmainVJ.jpg")
    Tom_Ford_Sunglasses = Clothes(designer_name='Tom Ford', description='Sunglasses', price=385, image_url="/assets/TFSunglasses.jpg")
    Tom_Ford_Suits = Clothes(designer_name='Tom Ford', description='Suits', price=1205, image_url="/assets/TFSuit.jpg")
    ALD_Suits = Clothes(designer_name='Aime Leon Dore', description='Beige Suit', price=1200, image_url="/assets/ALDSuit.jpg")
    ALD_Winter_Jacket = Clothes(designer_name='Aime Leon Dore', description='Winter Jacket', price=800, image_url="/assets/ALDWinterJacket.jpg")
    CK_Underwear = Clothes(designer_name='Calvin Klein', description='Underwear', price=45, image_url="/assets/CKUnderwear.jpg")
    CK_Jeans = Clothes(designer_name='Calvin Klein', description='Jeans', price=195, image_url="/assets/CKJeans.jpg")
    Supreme_Denim_Jacket = Clothes(designer_name='Supreme', description='Denim Jacket', price=655, image_url="/assets/SupremeDenim.jpg")
    Supreme_Tracksuit = Clothes(designer_name='Supreme', description='Tracksuit', price=995, image_url="/assets/SupremeTracksuit.jpg")
    Burberry_Sunglasses = Clothes(designer_name='Burberry', description='Sunglasses', price=405, image_url="/assets/BurberrySunglasses.jpg")
    Burberry_Trenchcoat = Clothes(designer_name='Burberry', description='Trenchcoat', price=2305, image_url="/assets/BurberryTrench.jpg")
